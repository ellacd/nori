...
#define nstr_from_static(n,s) bfromStatic(n,s)
...
#define nstr_assign_static(n,s) bassignStatic(n,s)
...
#define nstr_concat_static(n,s) bcatStatic(n,s)
...
#define nstr_insert_static(n,s) binsertStatic(n,s)
...
#define nstr_is_eq_static(n,s) biseqStatic(n,s)
#define nstr_is_eq_static_caseless(n,s) biseqcaselessStatic(n,s)
#define nstr_is_stem_eq_static(n,s) bisstemeqStatic(n,s)
#define nstr_is_stem_eq_static_caseless(n,s) bisstemeqcaselessStatic(n,s)
...
#define nstr_join_static(n,s) bjoinStatic(n,s)
...
// bstring's reference building macros are omitted until I find out what they're for
